    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      {isStamp ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-1.5"><Label htmlFor="quantity">{q.quantity}</Label><Input id="quantity" required={!isBusinessCard} inputMode="numeric" placeholder={q.quantityPlaceholder} value={isBusinessCard ? "1000" : form.quantity} disabled={isBusinessCard} onChange={(e) => update("quantity", e.target.value)} /></div>

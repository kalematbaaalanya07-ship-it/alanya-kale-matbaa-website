        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "2. Tasarımcılarımьz 30 dakika içinde mock-up (görüntü) hazırlar.",
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        metaDescription:
          "Срочнаь печать в Аланье: дизайн 1 час, пьчать 2-3 часа. Şekerhane, Mahmutlar, Oba, Konaklı. Заказы через WhatsApp.",
        intro: [
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "В: Когда печати ломаются или износились? О: Средниь срок 3-5 лет. При интенсивном использовании 1-2 года, при лёгком 5-10 лет.",
              "В: У нас нет дизайна, можеть создать с нуля? О: Да. Скажиье имя, должность, адрес. Макет за 30-45 минут.",
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              "Canva Pro kullanıyorsanız renk profilini CMYK seçin: Ücretsiz hesaplarda RGB çıkar, biz dönüşümьnü yapabiliriz.",
            ],
          },
          {
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              "Скачайте как PDF для п��чаьи: Наьмьте Поделиться > Загрьзьть в верхнем правом углу. Выберите PDF для печати (не PDF Standard). Отметььье метки обреьььи и выпуск за обрез.",
          ...
          },
          {
            ...
            bullets: [
              "Мы принимаем файлы Canva (PDF или сьылка для общего доступа)",
          ...
          },
          {
            ...
            bullets: [
              ...
              "Отправьте как PDF или ссылку для обьего доступа Canva",
            ],
          },
        ],
        ...
        sections: [
          {
            ...
            bullets: [
              "��ечатные файлы - это файлы, которые типография будет использовать непосредственно в производстве. Макет, изображения, текст и специальные эффекты (фольга, лак, высечка…) - всё это входит в него.",
          ...
          },
          {
            ...
            bullets: [
              "Мы постоянно видим одинакьвые ошибки в стандартных продуктах, таких как листовки, папки и плакаты: текст и логотипы слишком близко к краям (отсутствуют безопасные поля)",
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              ...
              "Eьik eksenler, devasa harfler ve ritmik tekrarlar gerilim yaratıyor. Sıradan fontlar yerine deneysel ve kişilik sahibi yazı tipleri tercih ediliyor.",
            ],
          },
          {
          ...
          },
          {
            ...
            bullets: [
              "Pantone, 2026 Yılьn Rengi'ni gürültülь bir dünyada sakinlik ve huzur dokunuşu sloganıyla tanıttı.",
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: "Руководство по печати и типографии для владельцев магазинов в Алань: Начните свой бренд сильно с первогь дня",
        excerpt:
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        excerpt:
          "Цифровая печать лучше для коротких тиражей, офсет для больших. Узнайте, как они работают, различия в качестве и какую выбрьть.",
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              "Прямая передача с файла на бьмагу без пьастин: Использует технологию струйной или лазерной печати.",
              "Время установки почти равно нул��: Печать может начаться сразу после загрузки файла.",
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        title: "Значимые печатные подарки: Остьвьте своим любимым неизгладимое впечатление",
        excerpt:
        ...
        metaDescription:
          "Значимые подарочьые печати: личные фото, постеры с цитатами, книги памяти, открытки рождения, календари. Подарите особенные подарки с Alanya Kale Matbaa.",
        intro: [
          "Обычные подарки забываются, но значимые печати хранят��я годами. На дни рождения, юбилеи, выпускные, новые дома, рождение, пенсию или просто чтобы сказать 'я о тебе думаю'; личный, эмоциональный и осязаемый печатный материал - один из самых искренних подарков.",
          "С нашим 35-летним ьпытом в Alanya Kale Matbaa мы производим не просто печать, но изделия, несущие смысл. С помощью Konica Minolta AccurioPrint C4065 яркие цвета, различные веса картона и ламинация делают ваш подарок значимым.",
        ],
        sections: [
          {
          ...
          },
          {
            ...
            bullets: [
              "Могу ли я получить одну индивидуальную печать? – Да. Производство в единичном или малом количестве очень распространено для значимьх подарков.",
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              "Дополнительные услуги: УФ-лак и тьснение",
  ...
  },
  {
    ...
    content: {
      tr: {
        ...
        cta: "Menünüzü profesyonelleştirmek için bize ulaşьn."
      },
      en: {
        category: "Menu",
  ...
  },
  {
    ...
    content: {
      tr: {
        ...
        title: "NFC'li Akıllı Masa Kartları: Restoran ve İşletmeler İçin Wi-Fi ve Google Yorum QR Kartı",
        excerpt: "NFC destekli ve QR kodlu masa kartlarıyla müşterilerinize kolay Wi-Fi erişimi sunun, Google yorumlarını artırın.",
        metaTitle: "NFC'li Akıllı Masa Kartı: Wi-Fi ve Google Yorum QR Kartı | Alanya Kale Matbaa",

        ...
        sections: [
          {
            ...
            bullets: [
              "Искусственный интеллект по-прежнему важен, но настоящие лидеры - люди. Дизайнеры используют генеративные инструменты как трамплин для творчества, а затем ��ознат��льно совершенствуют и направляют результаты.",
        ...
        sections: [
          {
            ...
            bullets: [
              ...
              "Меню, прайс-лист и каталог: Необходимы для ресторанов, кафе, бутиков или сервисных компаний. Устойчивые к влаге и пятнам ламинир��ванные меню или цифровые каталоги одновременно элегантны и практичны.",

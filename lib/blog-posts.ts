        ...
        sections: [
          {
            ...
            bullets: [
              ...
              "Скачайте как PDF для печа��и: Нажмите Поделиться > Загрузить в верхнем правом углу. Выберите PDF для печати (не PDF Standard). Отметь����е метки обре��ки и выпуск за обрез.",
  ...
  },
  {
    ...
    content: {
      ...
      ru: {
        ...
        metaDescription:
          "Печатные материалы и услуги типографии при откр��тии магазина в Алань. Визитные карточки, меню, брошюры, офсетная печать, изготовление печатей.",
        intro: [

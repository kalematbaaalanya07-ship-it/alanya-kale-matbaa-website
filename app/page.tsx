      ...
      <section className="border-b border-border bg-background">
        <div className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
          <div className="mx-auto flex max-w-4xl flex-col gap-5 text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg font-medium leading-relaxed text-foreground/85 text-pretty">{t.home.introDesc}</p>
          ...
          <div className="relative mt-8 min-h-[300px] overflow-hidden sm:mt-10 sm:min-h-[440px] lg:min-h-[620px]">
            <Image
